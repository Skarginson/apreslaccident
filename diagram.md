...
flowchart TD
    ...
    A[Préparation de la Partie] --> A1[Créer 5 Paquets]
    A1 --> B[Création du Paquet Histoire]
    B --> C[Définition du Cadre de Jeu]
    C --> D[Tirage de Carte et Déroulement de l'Histoire]

    %% Détails de chaque étape
    A1 --> A2[Paquet Cœur pour Acte 1]
    A1 --> A3[Paquet Carreau pour Acte 2]
    A1 --> A4[Paquet Trèfle pour Acte 3]
    A1 --> A5[Paquet Pique 2 à 10 pour Pistes]
    A1 --> A6[Paquet Pique - As, Roi, Dame, Valet]
